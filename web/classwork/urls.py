...
from .views import SubjectListView, SubjectCreateView, SessionListView, SessionCreateView

urlpatterns = [
    # path('', PublishedListView.as_view(), name='published'),
    # path('', ClassOfferListView.as_view(), name='class_list'),
    # path('new/', ClassOfferCreateView.as_view(), name='classoffer_create'),
    # path('<int:id>', ClassOfferDetailView.as_view(), name='class_detail'),
