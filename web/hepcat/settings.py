...
COUNTRIES_FIRST = os.environ.get('COUNTRIES_FIRST', DEFAULT_COUNTRY).split(',')
COUNTRIES_FIRST_SORT = os.environ.get('COUNTRIES_FIRST_SORT', False)
COUNTRIES_FIRST_REPEAT = os.environ.get('COUNTRIES_FIRST_REPEAT', True)
COUNTRIES_FIRST_BREAK = os.environ.get('COUNTRIES_FIRST_BREAK', '(Select Country)')
